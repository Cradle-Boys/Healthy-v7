...
public abstract class CalendarUtil {
    ...
    /**
     * using this to simulate daily reset (instead of one day, it is one minute)
     */

    public static long getNowPlusMinute() {

        Calendar c = Calendar.getInstance();

        c.setTimeInMillis(System.currentTimeMillis()+60000);
