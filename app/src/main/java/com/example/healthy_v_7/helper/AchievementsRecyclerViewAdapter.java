...
public class AchievementsRecyclerViewAdapter extends RecyclerView.Adapter<AchievementsRecyclerViewAdapter.ViewHolder> {
    ...
    public AchievementsRecyclerViewAdapter(Context mcontext, ArrayList<String> mImageTexts, ArrayList<Integer> mImages) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_list_item_achievements, parent, false);
